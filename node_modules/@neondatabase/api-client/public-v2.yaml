...
tags:
- name: API Key
  description: These methods allow you to create and manage API keys for your Neon
    account. For related information, see [Manage API keys](https://neon.tech/docs/manage/api-keys).
- name: Operation
  description: These methods allow you to view operation details for your Neon project.
    For related information, see [Operations](https://neon.tech/docs/manage/operations).
- name: Project
  description: These methods allow you to create and manage Neon projects. For related
    information, see [Manage projects](https://neon.tech/docs/manage/projects).
- name: Branch
  description: These methods allow you to create and manage branches in your Neon
    project. For related information, see [Manage branches](https://neon.tech/docs/manage/branches).
- name: Endpoint
  description: These methods allow you to create and manage compute endpoints in your
    Neon project. For related information, see [Manage compute endpoints](https://neon.tech/docs/manage/endpoints).
- name: Preview
...
paths:
  ...
  /projects:
    get:
      ...
      parameters:
      - name: cursor
        description: Specify the cursor value from the previous response to get the
          next batch of projects.
        in: query
        schema:
          type: string
      - name: limit
        description: Specify a value from 1 to 400 to limit number of projects in
          the response.
        in: query
        schema:
          type: integer
    ...
    get:
      ...
      - name: cursor
        ...
        schema:
          type: string
      - name: limit
        description: Specify a value from 1 to 1000 to limit number of operations
          in the response
        in: query
        schema:
          type: integer
    ...
    get:
      ...
      - name: cursor
        ...
        schema:
          type: string
      - name: limit
        description: Specify a value from 1 to 1000 to limit number of projects in
          the response.
        in: query
        schema:
          type: integer
      ...
      responses:
        200:
          description: Returned a list of project consumption metrics for the Neon
            account
          content:
            application/json:
              schema:
      ...
      content:
        application/json:
          schema:
            ...
            - $ref: "#/components/schemas/EndpointsResponse"
    CreatedBranch:
      description: Created a branch. An endpoint is only created if it was specified
        in the request.
      content:
        application/json:
          schema:
  ...
  schemas:
    ...
    ApiKeyCreateRequest:
      ...
      properties:
        key_name:
          type: string
          description: A user-specified API key name. This value is required when
            creating an API key.
    ...
    ApiKeyRevokeResponse:
      ...
      properties:
        ...
        name:
          ...
          type: string
        revoked:
          description: A `true` or `false` value indicating whether the API key is
            revoked
          type: boolean
        last_used_at:
    ...
    PgSettingsData:
      ...
      additionalProperties:
        type: string
    PgVersion:
      description: The major PostgreSQL version number. Currently supported versions
        are `14`, `15` and `16`.
      type: integer
      minimum: 14
      maximum: 16
